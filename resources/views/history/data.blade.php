                  ...
                  <div class="card card-plain">
                    ...
                    <div class="card-body">
                      <form role="form text-left" id="formUploadFoto">
                        ...
                        <div class="input-group mb-3">
                            <input type="file" class="form-control" accept="image/png" placeholder="File Foto" name="fileFoto" id="fileFoto" >
                        </div>
                        <div class="text-center">
                            <button type="button" data-id="" class="btn btn-round bg-gradient-info btn-lg w-100 mt-4 mb-0 btnSubmitFoto">
                                <span class="btn-inner--icon">
                        ...
                        Swal.fire({
                            ...
                            icon: "success"
                                ...
                                success : function(respond){
                                    if (respond == 0){
                                        window.location.replace('{{ route("historyinput") }}');
                                    }else{
                                        alert(error);
                                    }
                                }
