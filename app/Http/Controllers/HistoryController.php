...
class HistoryController extends Controller
{
    ...
    function sendWasis(Request $request,$id)
    {
        ...
        $pakan_num=(int)$data_survey->jumlah_pakan;
        $pakan_sumber='';
        $pakan_harga=(int)$data_survey->harga_pakan;
        $benur_sumber='';
        $benur_num=(int)$data_survey->jumlah_benih;
        $benur_harga=(int)$data_survey->harga_benih;
        $jarak_tambak=((int)trim($data_survey->jarak_pantai) == 0) ? '' : $data_survey->jarak_pantai;
        ...
        $family_num=(int)$data_survey->jumlah_keluarga;
        $biaya_media=(int)$data_survey->biaya_pembuatan_media_pemeliharaan;
        $biaya_susut=(int)$data_survey->biaya_penyusutan;
        $biaya_tk=(int)$data_survey->biaya_tenaga_kerja;
        $income=(int)$data_survey->pendapatan;
        $biaya_pakan=(int)$data_survey->biaya_pakan;
        $biaya_benih=(int)$data_survey->biaya_benih;
